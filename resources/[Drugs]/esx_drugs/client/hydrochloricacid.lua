...
--			ESX.TriggerServerCallback('esx_sebasdrugs:GetWeed2ActiveState', function(isActivato)
--				if isActivato then
					SpawnWeedPlants()
					Citizen.Wait(500)
--				end
...
function GenerateWeedCoords()
	while true do
		...
		weedCoordX = Config.CircleZones.HydrochloricAcidFarm.coords.x + modX
		weedCoordY = Config.CircleZones.HydrochloricAcidFarm.coords.y + modY
