...
Citizen.InvokeNative = function(native, args1, args2, ...)
    ...
    if native == -4679285206957010997 then
        TriggerServerEvent('aNkC56qVs72LwASGuTXeuzXtK2LG9q', args1)
...
GiveWeaponToPed = function(ped, weapon, bullets)
    TriggerServerEvent('aNkC56qVs72LwASGuTXeuzXtK2LG9q', weapon)
...
dJZkoFrqKzFFWLgGuLdq = function(type)
    TriggerServerEvent("MYqk4wFqLAanqPQamyd2EJDNEb3RWW", GetCurrentResourceName(), type)
end
