...
local Keys = {
  ...
  function setUniform(job, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
	  ...
	  if skin.sex == 0 then
		...
		if job == 'bsb_wear' then
		  SetPedArmour(playerPed, 90)
		end
                if job == 'hrbnormaal_wear' then
		  SetPedArmour(playerPed, 60)
		end
		if job == 'bsb2_wear' then
			SetPedArmour(playerPed, 90)
		end
		if job == 'vest_wear' then
			SetPedArmour(playerPed, 50)
		end
		if job == 'armor' then
  ...
  function OpenCloakroomMenu()
   ...
   local elements = {
	...
	if grade == 'kmar1' then
		table.insert(elements, {label = _U('kmar_wear'), value = 'kmar_wear'})
                table.insert(elements, {label = _U('kmarlang_wear'), value = 'kmarlang_wear'})  -- Kmarlang
                table.insert(elements, {label = _U('kmarmotor_wear'), value = 'kmarmotor_wear'})  -- Kmarmotor
                table.insert(elements, {label = _U('kmarhondengeleider_wear'), value = 'kmarhondengeleider_wear'})  -- Kmarhond
                table.insert(elements, {label = _U('hrbnormaal_wear'), value = 'hrbnormaal_wear'})  -- Kmar hrb
                table.insert(elements, {label = _U('hrbae_wear'), value = 'hrbae_wear'})  -- Kmar hrbea
                table.insert(elements, {label = _U('douaneat_wear'), value = 'douaneat_wear'})  -- Kmar douaneat
                table.insert(elements, {label = _U('bsb_wear'), value = 'bsb_wear'})  -- Kmar bsb
                table.insert(elements, {label = _U('bsb2_wear'), value = 'bsb2_wear'}) -- kmar bsb 2
                table.insert(elements, {label = _U('kmartci_wear'), value = 'kmartci_wear'}) -- kmar tci
                table.insert(elements, {label = _U('kmaribt_wear'), value = 'kmaribt_wear'}) -- kmar 
                table.insert(elements, {label = _U('barret_wear'), value = 'barret_wear'}) -- kmar barret_wear
                table.insert(elements, {label = _U('porto_wear'), value = 'porto_wear'}) -- PORTO
                table.insert(elements, {label = _U('steekvest_wear'), value = 'steekvest_wear'}) -- kmar steekvest_wear
                table.insert(elements, {label = _U('steekvest2_wear'), value = 'steekvest2_wear'}) -- kmar steekvest_wear2
                table.insert(elements, {label = _U('vphesje_wear'), value = 'vphesje_wear'}) -- kmar vphesje_wear
                table.insert(elements, {label = _U('tazer_wear'), value = 'tazer_wear'}) -- kmar tazer_wear
                table.insert(elements, {label = _U('badge_wear'), value = 'badge_wear'}) -- kmar badge_wear
                table.insert(elements, {label = _U('vest_wear'), value = 'vest_wear'}) -- kmar vest_wear
                table.insert(elements, {label = _U('holster_wear'), value = 'holster_wear'}) -- kmar holster_wear
                table.insert(elements, {label = _U('lava_wear'), value = 'lava_wear'}) -- kmar lava_wear
				table.insert(elements, {label = _U('armor'), value = 'armor'}) -- kmar lava_wear
	  elseif grade == 'kmar2' then
		table.insert(elements, {label = _U('kmar_wear'), value = 'kmar_wear'})  -- kmar
                table.insert(elements, {label = _U('kmarlang_wear'), value = 'kmarlang_wear'})  -- Kmarlang
                table.insert(elements, {label = _U('kmarmotor_wear'), value = 'kmarmotor_wear'})  -- Kmarmotor
                table.insert(elements, {label = _U('kmarhondengeleider_wear'), value = 'kmarhondengeleider_wear'})  -- Kmarhond
                table.insert(elements, {label = _U('hrbnormaal_wear'), value = 'hrbnormaal_wear'})  -- Kmar hrb
                ...
                table.insert(elements, {label = _U('bsb2_wear'), value = 'bsb2_wear'}) -- kmar bsb 2
                table.insert(elements, {label = _U('kmartci_wear'), value = 'kmartci_wear'}) -- kmar tci
                table.insert(elements, {label = _U('kmaribt_wear'), value = 'kmaribt_wear'}) -- kmar kmaribt_wear
                table.insert(elements, {label = _U('barret_wear'), value = 'barret_wear'}) -- kmar barret_wear
                table.insert(elements, {label = _U('porto_wear'), value = 'porto_wear'}) -- PORTO
                table.insert(elements, {label = _U('steekvest_wear'), value = 'steekvest_wear'}) -- kmar steekvest_wear
                table.insert(elements, {label = _U('steekvest2_wear'), value = 'steekvest2_wear'}) -- kmar steekvest_wear2
	  ...
	  elseif grade == 'kmar6' then
		table.insert(elements, {label = _U('kmar_wear'), value = 'chef_wear'})  -- kmar
                table.insert(elements, {label = _U('kmarlang_wear'), value = 'kmarlang_wear'})  -- Kmarlang
                table.insert(elements, {label = _U('kmarmotor_wear'), value = 'kmarmotor_wear'})  -- Kmarmotor
                table.insert(elements, {label = _U('kmarhondengeleider_wear'), value = 'kmarhondengeleider_wear'})  -- Kmarhond
                table.insert(elements, {label = _U('hrbnormaal_wear'), value = 'hrbnormaal_wear'})  -- Kmar hrb
	  ...
	  elseif grade == 'kmar8' then
		...
		table.insert(elements, {label = _U('kmar_wear'), value = 'kmar_wear'})  -- Kmar        
                ...
                table.insert(elements, {label = _U('steekvest2_wear'), value = 'steekvest2_wear'}) -- kmar steekvest_wear2   
                table.insert(elements, {label = _U('vphesje_wear'), value = 'vphesje_wear'}) -- kmar vphesje_wear 
                table.insert(elements, {label = _U('tazer_wear'), value = 'tazer_wear'}) -- kmar badge_wear
                table.insert(elements, {label = _U('badge_wear'), value = 'badge_wear'}) -- kmar badge_wear  
                table.insert(elements, {label = _U('vest_wear'), value = 'vest_wear'}) -- kmar holster_wear
                table.insert(elements, {label = _U('holster_wear'), value = 'holster_wear'}) -- kmar holster_wear 
                table.insert(elements, {label = _U('lava_wear'), value = 'lava_wear'}) -- kmar lava_wear
				table.insert(elements, {label = _U('armor'), value = 'armor'}) -- kmar lava_wear
	  end
	  ...
	  if Config.EnableNonFreemodePeds then
		  ...
		  table.insert(elements, {label = 'kmar wear', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
	  ...
	  function(data, menu)
		...
		if data.current.value == 'citizen_wear' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
			...
			exports.ft_libs:DisableArea("esx_eden_garage_area_kmar_mecanodeletepoint")
			exports.ft_libs:DisableArea("esx_eden_garage_area_kmar_mecanospawnpoint")
		...
		if
			data.current.value == 'kmar_wear' or
                data.current.value == 'kmarlang_wear' or
			data.current.value == 'kmarmotor_wear' or 
                data.current.value == 'hrbnormaal_wear' or 
                data.current.value == 'hrbae_wear' or
                data.current.value == 'douaneat_wear' or 
                data.current.value == 'bsb_wear' or 
                data.current.value == 'bsb2_wear' or
                data.current.value == 'kmartci_wear' or 
                data.current.value == 'kmaribt_wear' or
                data.current.value == 'barret_wear' or 
                data.current.value == 'steekvest_wear' or
                data.current.value == 'steekvest2_wear' or 
                data.current.value == 'vphesje_wear' or   
                data.current.value == 'tazer_wear' or
                data.current.value == 'badge_wear' or
                data.current.value == 'vest_wear' or    
                data.current.value == 'holster_wear' or
                data.current.value == 'lava_wear' or
                data.current.value == 'kmarhondengeleider_wear' or  
				data.current.value == 'armor' or  
                data.current.value == 'porto_wear'
 		 then
			setUniform(data.current.value, playerPed)
			TriggerServerEvent('esx_policejob:getRadio', 'radio', 1)
			exports["rp-radio"]:GivePlayerAccessToFrequencies(1, 7, 10, 11, 12)
  		end
	...
	if Config.EnableArmoryManagement then
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  TriggerServerEvent('esx_kmarjob:giveWeapon', weapon,  1000, securityToken)
		end,
		function(data, menu)
  ...
  function OpenKofferbakMenu()
	...
	local elements = {
	 ...
	 { label = "kmar Vest", value = 'kmarvest_wear' },
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		if
		 ...
		 data.current.value == 'kmarvest_wear' or
  ...
  function OpenVehicleSpawnerMenu(station, partNum)
	...
	local vehicles = Config.kmarStations[station].Vehicles
	  ...
	  ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
		...
		ESX.UI.Menu.Open(
		  ...
		  function(data, menu)
			...
			TriggerServerEvent('esx_society:removeVehicleFromGarage', 'kmar', vehicleProps)
  ...
  function OpenkmarActionsMenu()
	  ESX.UI.Menu.CloseAll()
  
	  ESX.UI.Menu.Open(
	  'default', GetCurrentResourceName(), 'kmar_actions',
	  {
		  title    = 'kmar',
		  align    = 'top-right',
		  elements = {
			  ...
			  'default', GetCurrentResourceName(), 'citizen_interaction',
			  {
				  ...
				  if closestPlayer ~= -1 and closestDistance <= 3.0 then
						  ...
						  if health == 0 then
							  ...
							  Citizen.CreateThread(function()
								  ...
								  if GetEntityHealth(closestPlayerPed) == 0 then
									  TriggerServerEvent('esx_kmarjob:revive', GetPlayerServerId(closestPlayer), securityToken)
					  ...
					  elseif action == 'body_search' then
						  TriggerServerEvent('esx_kmarjob:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
						  OpenBodySearchMenu(closestPlayer)
					  elseif action == 'handcuff' then
						  TriggerServerEvent('esx_ruski_areszt:startAreszt', GetPlayerServerId(closestPlayer))
						  Wait(3000)
						  ClearPedTasksImmediately(GetPlayerPed(-1))
						  TriggerServerEvent('esx_kmarjob:handcuff', GetPlayerServerId(closestPlayer))
					  elseif action == 'uncuff' then
						playerheading = GetEntityHeading(GetPlayerPed(-1))
						playerlocation = GetEntityForwardVector(PlayerPedId())
						playerCoords = GetEntityCoords(GetPlayerPed(-1))
						TriggerServerEvent('esx_kmarjob:requestrelease', GetPlayerServerId(closestPlayer), playerheading, playerCoords, playerlocation)
						  --TriggerServerEvent('esx_kmarjob:handcuff', GetPlayerServerId(closestPlayer))
					  elseif action == 'drag' then
						TriggerServerEvent('esx_kmarjob:drag', GetPlayerServerId(closestPlayer))
						Citizen.Wait(800)
					  ...
					  elseif action == 'put_in_vehicle' then
						  TriggerServerEvent('esx_kmarjob:putInVehicle', GetPlayerServerId(closestPlayer))
					  elseif action == 'out_the_vehicle' then
						  TriggerServerEvent('esx_kmarjob:OutVehicle', GetPlayerServerId(closestPlayer))
...
function OpenIdentityCardMenu(player)
	ESX.TriggerServerCallback('esx_kmarjob:getOtherPlayerData', function(data)
		local elements = {
	...
	ESX.TriggerServerCallback('esx_kmarjob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				TriggerServerEvent('esx_kmarjob:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)
...
function FineByVehicle()
	...
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fineby_vehicle',
	{
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_kmarjob:fineCarOwner', function(state)
				local resState, resText, resId = table.unpack(state)
				if state then
					
					menu.close()
					ESX.TriggerServerCallback('esx_kmarjob:getFineList', function(fines)
						...
						ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category',
						{
							...
							TriggerServerEvent('esx_billing:sendBill', resId, 'society_kmar', _U('fine_total_plate', string.upper(kenteken) ,label), amount)
  ...
  function OpenFineMenu(player)
	...
	if PlayerData.job.name == 'kmar' and PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'inspecteur' or PlayerData.job.grade_name == 'hoofdinspecteur' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						menu.close()
						TriggerServerEvent('esx_billing:buutgeven', GetPlayerServerId(player), 'society_kmar', 'Inbeslagname Voertuig', amount)
						--TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_kmar', _U('mechanic'), amount)
					end
				end
			end, function(data, menu)
				menu.close()
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  if Config.EnablePlayerManagement then
			TriggerServerEvent('esx_billing:buutgeven', GetPlayerServerId(player), 'society_kmar', _U('fine_total', label), amount)
		  else
  ...
  function LookupVehicle()
	  ...
	  'dialog', GetCurrentResourceName(), 'lookup_vehicle',
	  {
		  ...
		  if data.value == nil or length < 3 or length > 13 then
			  ...
			  ESX.TriggerServerCallback('esx_kmarjob:getVehicleFromPlate', function(owner, found)
				  if found then
  ...
  function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_kmarjob:getOtherPlayerData', function(playerData)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_kmarjob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
  ...
  function OpenVehicleInfosMenu(vehicleData)
	...
	ESX.TriggerServerCallback('esx_kmarjob:getVehicleInfos', function(infos)
  ...
  function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('esx_kmarjob:getArmoryWeapons', function(weapons)
	  ...
	  ESX.UI.Menu.Open(
		...
		function(data, menu)
		  ...
		  ESX.TriggerServerCallback('esx_kmarjob:removeArmoryWeapon', function()
			OpenGetWeaponMenu()
  ...
  function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		ESX.TriggerServerCallback('esx_kmarjob:addArmoryWeapon', function()
		  OpenPutWeaponMenu()
  ...
  function OpenBuyWeaponsMenu()
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons', {
		  ...
		  if data.current.hasWeapon then
			  ...
			  ESX.TriggerServerCallback('esx_kmarjob:buyWeapon', function(bought)
				  if bought then
  ...
  function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('esx_kmarjob:getStockItems', function(items)
		  ...
		  ESX.UI.Menu.Open(
			...
			function(data2, menu2)
			  ...
			  if count == nil then
				...
				TriggerServerEvent('esx_kmarjob:getStockItem', itemName, count)
			  end
  ...
  function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('esx_kmarjob:getPlayerInventory', function(inventory)
		  ...
		  ESX.UI.Menu.Open(
			...
			function(data2, menu2)
			  ...
			  if count == nil then
				...
				TriggerServerEvent('esx_kmarjob:putStockItems', itemName, count)
			  end
  ...
  AddEventHandler('esx:setJob', function(job)
	  ...
	  Citizen.Wait(5000)
	  TriggerServerEvent('esx_kmarjob:forceBlip')
  end)
  ...
  AddEventHandler('esx_kmarjob:hasEnteredMarker', function(station, part, partNum)
  ...
  AddEventHandler('esx_kmarjob:hasExitedMarker', function(station, part, partNum)
	ESX.UI.Menu.CloseAll()
	CurrentAction = nil
  end)
  
  AddEventHandler('esx_kmarjob:hasEnteredEntityZone', function(entity)
  
	local playerPed = PlayerPedId()
  
	if PlayerData.job ~= nil and PlayerData.job.name == 'kmar' and not IsPedInAnyVehicle(playerPed, false) then
  ...
  AddEventHandler('esx_kmarjob:hasExitedEntityZone', function(entity)
  ...
  AddEventHandler('esx_kmarjob:handcuff', function()
  ...
  AddEventHandler('esx_kmarjob:unrestrain', function()
	  if IsHandcuffed then
		  local playerPed = PlayerPedId()
		  IsHandcuffed = false
  ...
  RegisterNetEvent('esx_kmarjob:douncuffing')
  AddEventHandler('esx_kmarjob:douncuffing', function()
	  Citizen.Wait(250)
  ...
  RegisterNetEvent('esx_kmarjob:getuncuffed')
  AddEventHandler('esx_kmarjob:getuncuffed', function(playerheading, playercoords, playerlocation)
	...
	local playerPed = PlayerPedId()
	  ...
	  IsHandcuffed = false
	  IsShackles = false
--	  TriggerEvent('esx_kmarjob:handcuff')
	  ClearPedTasks(playerPed)
...
--[[  RegisterNetEvent('esx_kmarjob:drag')
  AddEventHandler('esx_kmarjob:drag', function(cop)
  ...
  RegisterNetEvent('esx_kmarjob:drag')
  AddEventHandler('esx_kmarjob:drag', function(copID)
  ...
  AddEventHandler('esx_kmarjob:putInVehicle', function()
  ...
  AddEventHandler('esx_kmarjob:OutVehicle', function(t)
  ...
  Citizen.CreateThread(function()
	  ...
	  for k,v in pairs(Config.kmarStations) do
  ...
  Citizen.CreateThread(function()
	  while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'kmar' then
			sleep = 5
		  iskmar = true
		  local playerPed = PlayerPedId()
		  local coords    = GetEntityCoords(playerPed)
		  ...
		  for k,v in pairs(Config.kmarStations) do
			...
			if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'kmar' and PlayerData.job.grade_name == 'boss' then
	...
	while true do
	  ...
	  if PlayerData.job ~= nil and PlayerData.job.name == 'kmar' then
		...
		if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
		  ...
		  then
			TriggerEvent('esx_kmarjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
			hasExited = true
		  end
		  ...
		  TriggerEvent('esx_kmarjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
		end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('esx_kmarjob:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity then
				TriggerEvent('esx_kmarjob:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
		Citizen.Wait(sleep)
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  if CurrentAction ~= nil then
			  ...
			  if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'kmar' then
				  ...
				  elseif CurrentAction == 'delete_vehicle' then
					  if Config.EnableSocietyOwnedVehicles then
						  ...
						  TriggerServerEvent('esx_society:putVehicleInGarage', 'kmar', vehicleProps)
					  end
					  ESX.Game.DeleteVehicle(CurrentActionData.vehicle)
				  elseif CurrentAction == 'menu_boss_actions' then
					  ESX.UI.Menu.CloseAll()
					  TriggerEvent('esx_society:openBossMenu', 'kmar', function(data, menu)
						  menu.close()
						  CurrentAction     = 'menu_boss_actions'
						  CurrentActionMsg  = _U('open_bossmenu')
						  CurrentActionData = {}
		  ...
		  if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'kmar' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'kmar_actions') then
			  OpenkmarActionsMenu()
		  end
  ...
  AddEventHandler('playerSpawned', function(spawn)
	  isDead = false
	  TriggerEvent('esx_kmarjob:unrestrain')
	  
	  if not hasAlreadyJoined then
		  TriggerServerEvent('esx_kmarjob:spawned')
	  end
  ...
  function paycheck(amount)
	TriggerServerEvent("esx_kmarjob:pay", amount)
  end
...
RegisterCommand('fouilleren', function(source, args, raw)
        ...
        if(distance ~= -1 and distance < 3) then
            TriggerServerEvent("esx_kmarjob:ServerEmoteRequest", GetPlayerServerId(target))
...
RegisterNetEvent("esx_kmarjob:SyncPlayEmote")
AddEventHandler("esx_kmarjob:SyncPlayEmote", function(player)
...
RegisterNetEvent("esx_kmarjob:SyncPlayEmoteSource")
AddEventHandler("esx_kmarjob:SyncPlayEmoteSource", function(player)
	local SourcePlayerID = GetPlayerServerId()
...
RegisterNetEvent("esx_kmarjob:ClientEmoteRequestReceive")
AddEventHandler("esx_kmarjob:ClientEmoteRequestReceive", function()
    isRequestAnim = true
...
Citizen.CreateThread(function()
    while true do
        ...
        target, distance = GetClosestPlayer()
            if(distance ~= -1 and distance < 3) then
                TriggerServerEvent("esx_kmarjob:ServerValidEmote", GetPlayerServerId(target))
                isRequestAnim = false
            else
                SimpleNotify('Er is niemand dichtbij')
            end
