...
-- Cannab's random fire spawner
-- Citizen.CreateThread(function()
-- 	while true do
-- 		local nextRandomFire = math.random(120000, 420000)
-- 		local firePlace = math.random(1, #PlannedScenarios)
		
-- 		local success = Fire:startRegistered(firePlace, triggerDispatch, 1)
