...
ESX.RegisterServerCallback('esx_mechanicjob:getFineList', function(src, cb, category)
	MySQL.Async.fetchAll('SELECT * FROM `anwb_factuur` WHERE category = ?', {category}, function(res)
