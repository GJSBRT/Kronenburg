...
local zoomspeed = 50.0 -- camera zoom speed
...
local polmav_hash2 = GetHashKey("annihilator")
...
Citizen.CreateThread(function()
	while true do
		...
		if (IsPlayerInPolmav() or IsPlayerInPolmav2()) and target_vehicle and not helicam and vehicle_display ~=2 then
