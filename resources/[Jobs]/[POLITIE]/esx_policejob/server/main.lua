...
RegisterServerEvent("esx_policejob:ServerEmoteRequest")
AddEventHandler("esx_policejob:ServerEmoteRequest", function(target)
	TriggerClientEvent("esx_policejob:ClientEmoteRequestReceive", target)
end)



RegisterServerEvent("esx_policejob:ServerValidEmote") 
AddEventHandler("esx_policejob:ServerValidEmote", function(target)
	TriggerClientEvent("esx_policejob:SyncPlayEmote", source, source)
	TriggerClientEvent("esx_policejob:SyncPlayEmoteSource", target)
end)