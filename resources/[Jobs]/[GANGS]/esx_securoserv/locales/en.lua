Locales['en'] = {
  ...
  ['gilet_wear'] = 'Reflecterende Jas',
  ['bullet_wear'] = 'Kogelvrij Vest',
  ['no_outfit'] = 'Er is geen outfit die jou past',
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Burgerinteracties',
  ...
  ['drag'] = 'Meenemen',
  ['put_in_vehicle'] = 'In Waggie Stoppen',
  ['out_the_vehicle'] = 'Uit Waggie Halen',
  ['fine'] = 'Bekeuren',
  ['unpaid_bills'] = 'Openstaande Rekeningen',
  ['license_check'] = 'Beweer Rijbewijs',
