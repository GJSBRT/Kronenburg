...
TriggerEvent('chat:addMessage', { args = { 'AMBULANCE: ', "Het kan zijn dat de ambulancier u niet kan zien, doe dan /e bewaken en vervolgens druk je op de X spier." }, color = { 255, 50, 50 } })
	isDead = true
	ESX.UI.Menu.CloseAll()
	TriggerServerEvent('esx_ambulancejob:setDeathStatus', true)

	StartDeathTimer()
	Citizen.SetTimeout(15000, StartDistressSignal)
