...
AddEventHandler('esx_basicneeds:onEat', function(prop_name)
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			local prop = Citizen.InvokeNative(0x509D5878EB39E842,GetHashKey(prop_name), x, y, z + 0.2, true, true, true)
...
AddEventHandler('esx_basicneeds:onBeer', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_beer_pissh'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onTeq')
AddEventHandler('esx_basicneeds:onTeq', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('esx_basicneeds:onVodka')
AddEventHandler('esx_basicneeds:onVodka', function(prop_name)
	if not IsAnimated then
...
AddEventHandler('esx_basicneeds:onWhisky', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'p_whiskey_notop'
		IsAnimated = true
