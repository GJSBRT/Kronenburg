...
RegisterServerEvent("esx_aircraftshop:getIsAllowed")
AddEventHandler("esx_aircraftshop:getIsAllowed", function()
    if IsPlayerAceAllowed(source, "vliegbrevet") then
        TriggerClientEvent("esx_aircraftshop:returnIsAllowed", source, true)
    else
        TriggerClientEvent("esx_aircraftshop:returnIsAllowed", source, false)
    end
end)