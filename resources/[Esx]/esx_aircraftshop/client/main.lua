...
Citizen.CreateThread(function()
	TriggerServerEvent("esx_aircraftshop:getIsAllowed")
end)

RegisterNetEvent("esx_aircraftshop:returnIsAllowed")
AddEventHandler("esx_aircraftshop:returnIsAllowed", function(isAllowed)
	...
	elseif zone == 'ResellVehicle' then
		...
		if IsPedSittingInAnyVehicle(playerPed) then
			...
			if GetPedInVehicleSeat(vehicle, -1) == playerPed then
				...
				CurrentActionMsg = _U('sell_menu', ESX.Math.GroupDigits(resellPrice))
