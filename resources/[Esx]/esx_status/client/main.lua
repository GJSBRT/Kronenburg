...
AddEventHandler('esx_status:load', function(status)
	...
	Citizen.CreateThread(function()
		while true do
			...
			TriggerEvent('emilia-customui:updateStatus', GetStatusData(true))
...
local function doUpdate()
	Citizen.SetTimeout(Config.UpdateInterval, doUpdate)
	local data = GetStatusData(true)
	TriggerServerEvent('esx_status:update', data)
end

Citizen.SetTimeout(Config.UpdateInterval * 5, doUpdate)
