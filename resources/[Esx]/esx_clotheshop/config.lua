...
Config.Shops = {
	...
	vector3(199.6457, -873.4726, 30.7130),
	vector3(-796.1067, -601.8049, 30.2753)
}

Config.Cloakrooms = {
	vector3(268.1218, -272.6120, 52.9786),
	vector3(277.1531, -276.8231, 52.9786),
	vector3(-814.7225, -599.5717, 29.2753)
}
