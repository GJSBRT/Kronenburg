...
function JailLogin()
	...
	ESX.ShowNotification("je viel in slaap nu ben je weer wakker en terug gezet op de juiste plaats.")
...
function InJail()
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			ESX.ShowNotification("je hebt nog " .. jailTime .. " minuten in de bak!")
...
function LoadTeleporters()
	Citizen.CreateThread(function()
		...
		-- 			ESX.Game.Utils.DrawText3D(v, "[E] Open Deur", 0.4)
