...
ESX.RegisterServerCallback('esx_giveownedcar:server:getVerifyToken', function(source, cb)
	local src = source
...
-- AddEventHandler('esx_giveownedcar:setVehicle', function (vehicleProps, playerID, vehicleType, token)
-- 	local _source = playerID
-- 	if not exports['DRGNV_tokenizer']:verifyToken(GetCurrentResourceName(), _source, token, "esx_giveownedcar:setVehicle") then
--         return
--     end
...
AddEventHandler('esx_giveownedcar:setVehicle', function (vehicleProps, playerID, vehicleType, token)
	local _source = playerID
	local src = source
	if not exports['DRGNV_tokenizer']:verifyToken(GetCurrentResourceName(), src, token, "esx_giveownedcar:setVehicle") then
        return
    end
	local xPlayer = ESX.GetPlayerFromId(_source)
