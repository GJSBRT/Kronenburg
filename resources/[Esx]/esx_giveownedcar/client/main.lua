...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('esx_giveownedcar:server:getVerifyToken', function(token, eventname)
		verifyToken = token
...
AddEventHandler('esx_giveownedcar:spawnVehicle', function(playerID, model, playerName, type, vehicleType)
	...
	ESX.Game.SpawnVehicle(model, coords, 0.0, function(vehicle) --get vehicle info
		if DoesEntityExist(vehicle) then
			...
			TriggerServerEvent('esx_giveownedcar:setVehicle', vehicleProps, playerID, vehicleType, verifyToken)
