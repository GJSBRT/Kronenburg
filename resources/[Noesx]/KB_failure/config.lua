...
cfg = {
	...
	deformationExponent = 0.35,					-- How much should the handling file deformation setting be compressed toward 0.35. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	collisionDamageExponent = 0.35,				-- How much should the handling file deformation setting be compressed toward 0.35. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	damageFactorPetrolTank = 60.35,				-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 64
	engineDamageExponent = 0.35,					-- How much should the handling file engine damage setting be compressed toward 0.35. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
...
repairCfg = {
	mechanics = {
		...
		{name="Mechanic", id=446, r=25.0, x=108.0,   y=6624.0,  z=30.35},	-- LSC Paleto Bay
		{name="Mechanic", id=446, r=18.0, x=538.0,   y=-183.0,  z=54.0},	-- Mechanic Hawic
		{name="Mechanic", id=446, r=15.0, x=1774.0,  y=3333.0,  z=40.35},	-- Mechanic Sandy Shores Airfield
	...
	--	{name="Mechanic", id=446, r=24.0, x=288.0,   y=-1730.0, z=29.0},	-- Hayes Auto, Rancho (Disabled, looks like a warehouse for the Davis branch)
		...
		{name="Mechanic", id=446, r=44.0, x=-212.0,  y=-1378.0, z=30.35},	-- Glass Heroes, Strawberry
		...
		{name="Mechanic", id=446, r=25.0, x=-210.35,  y=-1325.0, z=30.35},	-- Bennys
	...
	fixMessages = {
		"Je steekt de olieplug er weer in",
		"Je hebt het olielek gestopt met kauwgom",
		"Je hebt de olieleiding gerepareerd met plakband",
		"U hebt de schroef van de oliepan aangedraaid en het druipen gestopt",
		"Je schopte de motor en het kwam op magische wijze weer tot leven",
		"Je hebt wat roest van de bougie verwijderd",
		"Je schreeuwde tegen je voertuig en het had op de een of andere manier positieve effect"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Je hebt de olieplug gecontroleerd. Hij zit er nog steeds in.",
		"Je keek naar je motor, het leek goed",
		"Je hebt ervoor gezorgd dat de plakband nog steeds de motor bij elkaar hield",
		"U hebt het radio-volume ingeschakeld. Het heeft de rare motorgeluiden overstemd",
		"Je hebt een roestbeschermer aan de bougie toegevoegd. Het maakte geen verschil",
		"Nooit iets repareren dat niet kapot is, zeiden ze. Je hebt niet geluisterd. Het werd tenminste niet erger"
	},
	noFixMessageCount = 6
}
