...
$(function(){
	window.addEventListener('message', function(event) {
		...
		} else if (event.data.action == "hud2"){
...
function setJobIcon(value){
	$('#job img').attr('src', 'https://cdn.dutchis.net/kbrp/hud/img/jobs/'+value+'.png')
	//$('#job img').attr('src', 'img/jobs/'+value+'.png')
}

function setJob2Icon(value){
	$('#job2 img').attr('src', 'https://cdn.dutchis.net/kbrp/hud/img/jobs/'+value+'.png')
}
